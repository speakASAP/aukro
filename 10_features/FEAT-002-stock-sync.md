...
Warehouse stock updates must update linked Aukro offers.

## Goal

Deliver stock sync within the documented Aukro marketplace boundary.
...
Existing aukro-service capability area for stock sync.
