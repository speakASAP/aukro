...
- `16_operations/AUKRO_PLATFORM_RULES.md` records official source URLs, review date, hard prohibitions, allowed operating model, WebAPI gaps, listing-content limits, prohibited/conditional goods, privacy/cookie rules, robots limits, and code evidence gates.
