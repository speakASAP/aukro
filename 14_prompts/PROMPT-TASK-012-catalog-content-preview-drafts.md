...
Use `13_context_packages/CP-TASK-012-catalog-content-preview-drafts.md`, `21_execution_plans/EP-TASK-012-catalog-content-preview-drafts.md`, FEAT-005, TASK-005 draft behavior, shared Catalog client, offer draft service/types/tests, and `services/aukro-service/src/ui/ui.controller.ts`.
