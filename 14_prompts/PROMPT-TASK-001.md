...
upstream:
  ...
  - 13_context_packages/CP-TASK-001.md
downstream:
...
Use `13_context_packages/CP-TASK-001.md`.

## Required context

`11_tasks/TASK-001-implement-ips-governance-baseline.md`, `21_execution_plans/EP-TASK-001.md`, `13_context_packages/CP-TASK-001.md`.
...
Record evidence in `12_validation/VAL-TASK-001-ips-governance-baseline.md` and generated reports.
