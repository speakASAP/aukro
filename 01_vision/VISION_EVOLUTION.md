...
AI agents must not change `01_vision/VISION.md` directly after baseline adoption. Intent changes require reviewed entries here or in `17_governance/amendments/`.
...
- Original vision reference: `01_vision/VISION.md`.
