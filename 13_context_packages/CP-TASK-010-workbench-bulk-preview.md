...
`TASK-010` in `11_tasks/TASK-010-workbench-bulk-preview.md`.

## Upstream Traceability

`00_constitution/CONSTITUTION.md`, `01_vision/VISION.md`, `08_roadmap/AI_COMMERCE_ROADMAP.md`, `09_milestones/MS-003-ai-commerce-platform.md`, Stage 6 roadmap section, TASK-009 docs and validation report, and local workbench review queue contracts.
