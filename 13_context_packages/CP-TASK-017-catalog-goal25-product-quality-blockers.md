...
`TASK-017` in `11_tasks/TASK-017-catalog-goal25-product-quality-blockers.md`.

## Upstream traceability

`00_constitution/CONSTITUTION.md`, `01_vision/VISION.md`, `10_features/FEAT-005-catalog-warehouse-publisher.md`, TASK-005, TASK-012, and Catalog Goal 25 policy `catalog.product_quality.v1`.
...
Run focused offer tests, service build, IPS gates, and `git diff --check`; record results in `12_validation/VAL-TASK-017-catalog-goal25-product-quality-blockers.md`.
