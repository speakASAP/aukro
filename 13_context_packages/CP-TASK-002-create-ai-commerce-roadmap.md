...
`TASK-002` in `11_tasks/TASK-002-create-ai-commerce-roadmap.md`.

## Upstream traceability

`00_constitution/CONSTITUTION.md`, `01_vision/VISION.md`, `02_business_case/BUSINESS_CASE.md`, `08_roadmap/AI_COMMERCE_ROADMAP.md`, `21_execution_plans/EP-TASK-002-create-ai-commerce-roadmap.md`.

## Included documents

AGENTS.md, 00_constitution/CONSTITUTION.md, 01_vision/VISION.md, 02_business_case/BUSINESS_CASE.md, 04_systems/SYS-001-aukro-service.md, 08_roadmap/ROADMAP.md, 08_roadmap/AI_COMMERCE_ROADMAP.md, 09_milestones/MS-003-ai-commerce-platform.md, 10_features/FEAT-004-aukro-compliance-policy.md through 10_features/FEAT-009-service-integration-clients.md, 16_operations/INTEGRATIONS.md, 17_governance/PROJECT_INVARIANTS.md, and 24_onboarding/AUKRO_AI_COMMERCE_ORCHESTRATOR.md.
