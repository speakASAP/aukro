...
`TASK-016` in `11_tasks/TASK-016-orders-create-synthetic-smoke.md`.

## Upstream traceability

`00_constitution/CONSTITUTION.md`, `01_vision/VISION.md`, `04_systems/SYS-001-aukro-service.md`, `10_features/FEAT-003-order-forwarding.md`, `10_features/FEAT-009-service-integration-clients.md`, `16_operations/INTEGRATIONS.md`, `12_validation/VAL-GOAL-7-2B-orders-create-auth-warehouse-readiness.md`, and `22_goal_impact/GOAL-IMPACT-TASK-016.md`.
