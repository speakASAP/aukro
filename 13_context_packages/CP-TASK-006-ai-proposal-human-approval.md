...
`TASK-006` in `11_tasks/TASK-006-ai-proposal-human-approval.md`.

## Upstream traceability

`00_constitution/CONSTITUTION.md`, `01_vision/VISION.md`, `08_roadmap/AI_COMMERCE_ROADMAP.md`, `10_features/FEAT-006-ai-human-workbench.md`, and `21_execution_plans/EP-TASK-006-ai-proposal-human-approval.md`.
