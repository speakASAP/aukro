...
`01_vision/VISION.md`, `02_business_case/BUSINESS_CASE.md`, `10_features/FEAT-001-offer-management.md`, `10_features/FEAT-002-stock-sync.md`, `10_features/FEAT-003-order-forwarding.md`.
...
Applies `17_governance/PROJECT_INVARIANTS.md`. No runtime behavior change.
...
Create `12_validation/VAL-TASK-001-ips-governance-baseline.md` and run gate commands.

## Execution Plan Requirement

Use `21_execution_plans/EP-TASK-001.md`.
