...
See `22_goal_impact/GOAL-IMPACT-TASK-014.md`. This task turns approved local publish requests into controlled live Aukro offer operations while keeping catalog, warehouse, order, policy, human approval, idempotency, and observability boundaries intact.
...
`AGENTS.md`, `AGENT_OPERATIONS.md`, protected intent docs, `16_operations/AUKRO_PLATFORM_RULES.md`, TASK-005/TASK-007/TASK-012/TASK-013 packages, offer/account/order/workbench services, Prisma account/offer/order models, k8s secret refs, and official Aukro OpenAPI.
...
Use `21_execution_plans/EP-TASK-014-official-aukro-public-api-executor.md` before coding. The plan is reviewed for fail-closed executor implementation, but it does not approve live marketplace mutation until credential refs, mapping evidence, rate-limit evidence, and an approved test listing exist.
