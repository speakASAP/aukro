...
`01_vision/VISION.md`, `04_systems/SYS-001-aukro-service.md`, `10_features/FEAT-005-catalog-warehouse-publisher.md`, `11_tasks/TASK-005-catalog-sell-action-draft-model.md`, and `16_operations/INTEGRATIONS.md`.

## Goal Impact

See `22_goal_impact/GOAL-IMPACT-TASK-012.md`. This task improves draft review quality by storing Catalog-rendered Aukro content evidence while keeping the draft-first marketplace safety model intact.
...
`AGENTS.md`, `AGENT_OPERATIONS.md`, protected intent docs, `10_features/FEAT-005-catalog-warehouse-publisher.md`, TASK-005 docs and validation, shared Catalog client, from-catalog offer service/controller/types/tests, and `services/aukro-service/src/ui/ui.controller.ts`.

## Validation Task

Create `12_validation/VAL-TASK-012-catalog-content-preview-drafts.md`, run the service tests/build, strict audit, pre-coding gate, deployment-readiness gate for TASK-012, and `git diff --check`.
...
Use `21_execution_plans/EP-TASK-012-catalog-content-preview-drafts.md` before coding.
