...
`01_vision/VISION.md`, `04_systems/SYS-001-aukro-service.md`, `08_roadmap/AI_COMMERCE_ROADMAP.md`, `10_features/FEAT-006-ai-human-workbench.md`, `16_operations/INTEGRATIONS.md`, and `16_operations/SERVICE_CLIENT_CONTRACTS.md`.

## Goal Impact

See `22_goal_impact/GOAL-IMPACT-TASK-006.md`. This task lets AI suggest improved draft content while preserving human accountability and marketplace safety.
...
Create `12_validation/VAL-TASK-006-ai-proposal-human-approval.md`, run service tests/build, strict audit, pre-coding gate, and deployment-readiness gate.
...
Use `21_execution_plans/EP-TASK-006-ai-proposal-human-approval.md` before coding.
