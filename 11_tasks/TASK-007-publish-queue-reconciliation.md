...
`01_vision/VISION.md`, `04_systems/SYS-001-aukro-service.md`, `08_roadmap/AI_COMMERCE_ROADMAP.md`, `10_features/FEAT-008-observability-reconciliation.md`, `16_operations/INTEGRATIONS.md`, and `16_operations/SERVICE_CLIENT_CONTRACTS.md`.

## Goal Impact

See `22_goal_impact/GOAL-IMPACT-TASK-007.md`. This task makes approved publish intent and reconciliation drift visible while preserving catalog, warehouse, policy, human approval, and idempotency gates before any later live Aukro mutation worker exists.
...
`AGENTS.md`, protected intent docs, `08_roadmap/AI_COMMERCE_ROADMAP.md`, `10_features/FEAT-008-observability-reconciliation.md`, TASK-005/TASK-006 docs and validation reports, offer service/controller, offer policy service, AI proposal review metadata, catalog client, warehouse client, and notifications/logging contract docs.

## Validation Task

Create and complete `12_validation/VAL-TASK-007-publish-queue-reconciliation.md`, run the new service test, service build, strict audit, pre-coding gate, and deployment-readiness gate.
...
Use `21_execution_plans/EP-TASK-007-publish-queue-reconciliation.md` before coding.
