...
`01_vision/VISION.md`, `04_systems/SYS-001-aukro-service.md`, `08_roadmap/AI_COMMERCE_ROADMAP.md`, `10_features/FEAT-005-catalog-warehouse-publisher.md`, and `16_operations/INTEGRATIONS.md`.

## Goal Impact

See `22_goal_impact/GOAL-IMPACT-TASK-005.md`. This task makes catalog products actionable in aukro-service while preserving draft-first marketplace safety.
...
`AGENTS.md`, protected intent docs, `10_features/FEAT-005-catalog-warehouse-publisher.md`, `16_operations/INTEGRATIONS.md`, `services/aukro-service/src/aukro/offers/*`, and shared catalog/warehouse clients.

## Validation Task

Create `12_validation/VAL-TASK-005-catalog-sell-action-draft-model.md`, run the new service test, service build, strict audit, pre-coding gate, and deployment-readiness gate.
...
Use `21_execution_plans/EP-TASK-005-catalog-sell-action-draft-model.md` before coding.
