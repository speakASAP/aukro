...
`01_vision/VISION.md`, `04_systems/SYS-001-aukro-service.md`, `10_features/FEAT-003-order-forwarding.md`, `10_features/FEAT-009-service-integration-clients.md`, `16_operations/INTEGRATIONS.md`, and `12_validation/VAL-GOAL-7-2B-orders-create-auth-warehouse-readiness.md`.

## Goal Impact

See `22_goal_impact/GOAL-IMPACT-TASK-016.md`. This task closes the Goal 7.2B validation gap by giving operators a repeatable runtime smoke that verifies Aukro-to-Orders readiness while preserving source-system boundaries.
...
`AGENTS.md`, `AGENT_OPERATIONS.md`, protected intent docs, `SYSTEM.md`, `10_features/FEAT-003-order-forwarding.md`, `16_operations/INTEGRATIONS.md`, `shared/clients/order-client.service.ts`, `services/aukro-service/src/aukro/orders/orders.service.ts`, and `12_validation/VAL-GOAL-7-2B-orders-create-auth-warehouse-readiness.md`.

## Validation Task

Create `12_validation/VAL-TASK-016-orders-create-synthetic-smoke.md`, run targeted smoke, service tests/build, strict audit, IPS gates, deploy if validation passes, and run the smoke inside the deployed pod.
...
Use `21_execution_plans/EP-TASK-016-orders-create-synthetic-smoke.md` before coding.
