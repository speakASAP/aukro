...
Validate with service policy tests, TypeScript build, strict documentation audit, pre-coding gate, and deployment-readiness gate. Evidence is recorded in `12_validation/VAL-TASK-003-aukro-compliance-policy.md` and generated gate reports under `reports/validation/`.
