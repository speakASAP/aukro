...
Vision -> `01_vision/VISION.md` -> Roadmap -> `08_roadmap/AI_COMMERCE_ROADMAP.md` -> Stage 6 -> Task -> `11_tasks/TASK-010-workbench-bulk-preview.md` -> Execution Plan -> `21_execution_plans/EP-TASK-010-workbench-bulk-preview.md` -> Coding Prompt -> `14_prompts/PROMPT-TASK-010-workbench-bulk-preview.md` -> Code -> Validation -> `12_validation/VAL-TASK-010-workbench-bulk-preview.md`.
