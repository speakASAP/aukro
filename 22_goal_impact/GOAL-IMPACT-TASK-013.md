...
- Existing publish-intent foundation: `11_tasks/TASK-007-publish-queue-reconciliation.md`.
- Existing content preview foundation: `11_tasks/TASK-012-catalog-content-preview-drafts.md`.
- Code path: `services/aukro-service/src/ui/ui.controller.ts`.
- Validation report: `12_validation/VAL-TASK-013-dashboard-bulk-publish-candidates.md`.
