...
downstream:
  - 01_vision/VISION.md
related_adrs:
  - 07_decisions/ADR-003-protect-intent-documents.md
---
...
This constitution and `01_vision/VISION.md` are protected. AI may read and cite them but must not change them after baseline adoption without a human-approved amendment.

### 3. Human-controlled change
Changes to purpose, marketplace behavior, order ownership, data handling, deployment ownership or AI autonomy require review in `17_governance/amendments/` or `01_vision/VISION_EVOLUTION.md`.
