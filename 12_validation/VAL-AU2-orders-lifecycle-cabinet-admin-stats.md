...
target: 10_features/FEAT-003-order-forwarding.md
owner: Engineering
created: 2026-07-02
...
Vision -> `01_vision/VISION.md` -> System -> `04_systems/SYS-001-aukro-service.md` -> Feature -> `10_features/FEAT-003-order-forwarding.md` -> AU2 Execution Plan -> `docs/orchestrator/2026-07-02-central-orders-status-read-model-plan.md` -> Code -> `services/aukro-service/src/ui/ui.controller.ts` -> Validation -> `12_validation/VAL-AU2-orders-lifecycle-cabinet-admin-stats.md`.
