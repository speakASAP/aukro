...
`TASK-001` and `21_execution_plans/EP-TASK-001.md`.
...
`01_vision/VISION.md`: safe Aukro.cz marketplace integration for offers, stock and order forwarding.
...
`17_governance/PROJECT_INVARIANTS.md` defines traceability, protected intent, execution-plan-before-code, validation evidence, sensitive-data handling and marketplace boundary invariants.
