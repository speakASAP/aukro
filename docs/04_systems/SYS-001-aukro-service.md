...
downstream:
  - docs/05_subsystems/SUB-001-api-gateway.md
  - docs/05_subsystems/SUB-002-marketplace-integration.md
  - docs/05_subsystems/SUB-003-stock-and-order-events.md
related_adrs:
  - docs/07_decisions/ADR-002-nestjs-prisma-postgres.md
---
...
`docs/01_vision/VISION.md` and `docs/02_business_case/BUSINESS_CASE.md`.

## Downstream artifacts

`docs/10_features/FEAT-001-offer-management.md`, `docs/10_features/FEAT-002-stock-sync.md`, `docs/10_features/FEAT-003-order-forwarding.md`.
