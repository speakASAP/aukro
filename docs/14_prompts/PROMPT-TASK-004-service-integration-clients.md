...
Use `docs/21_execution_plans/EP-TASK-004-service-integration-clients.md`.
...
Record evidence in `docs/12_validation/VAL-TASK-004-service-integration-clients.md`.
