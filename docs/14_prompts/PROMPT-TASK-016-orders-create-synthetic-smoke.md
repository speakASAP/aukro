...
Use `docs/13_context_packages/CP-TASK-016-orders-create-synthetic-smoke.md`, `docs/21_execution_plans/EP-TASK-016-orders-create-synthetic-smoke.md`, FEAT-003 order forwarding, FEAT-009 service integration clients, Orders service mapping, and shared Orders client request construction.
