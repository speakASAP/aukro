...
`docs/13_context_packages/CP-TASK-005-catalog-sell-action-draft-model.md`, `docs/21_execution_plans/EP-TASK-005-catalog-sell-action-draft-model.md`, FEAT-005, offer service/controller, policy service, and shared catalog/warehouse clients.
