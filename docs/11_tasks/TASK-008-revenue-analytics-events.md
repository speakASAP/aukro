...
`docs/01_vision/VISION.md`, `docs/04_systems/SYS-001-aukro-service.md`, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/10_features/FEAT-007-ecosystem-revenue-optimization.md`, `docs/16_operations/INTEGRATIONS.md`, and `docs/16_operations/SERVICE_CLIENT_CONTRACTS.md`.

## Goal Impact

See `docs/22_goal_impact/GOAL-IMPACT-TASK-008.md`. This task turns Aukro performance and blocker evidence into explainable, masked recommendation events so revenue work can be prioritized while catalog, marketing, supplier, payment, warehouse, AI, logging, and BI ownership remains outside aukro-service.
...
`AGENTS.md`, protected intent docs, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/10_features/FEAT-007-ecosystem-revenue-optimization.md`, `docs/16_operations/INTEGRATIONS.md`, `docs/16_operations/SERVICE_CLIENT_CONTRACTS.md`, TASK-004 client contracts, TASK-006 human review metadata, TASK-007 queue/reconciliation metadata, offer service/controller, and shared logging client.

## Validation Task

Create and complete `docs/12_validation/VAL-TASK-008-revenue-analytics-events.md`, run the new service test, service build, strict audit, pre-coding gate, and deployment-readiness gate.
...
Use `docs/21_execution_plans/EP-TASK-008-revenue-analytics-events.md` before coding.
