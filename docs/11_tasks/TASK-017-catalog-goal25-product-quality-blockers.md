...
`docs/01_vision/VISION.md`, `docs/10_features/FEAT-005-catalog-warehouse-publisher.md`, Catalog contract `catalog-product-quality-review.md`, and policy `catalog.product_quality.v1`.

## Goal Impact

See `docs/22_goal_impact/GOAL-IMPACT-TASK-017.md`. This task prevents Aukro drafts and publication intents from being prepared from Catalog products that still have mandatory Catalog quality blockers, while leaving account, draft, compliance, and marketplace publication ownership in Aukro.
...
Create `docs/12_validation/VAL-TASK-017-catalog-goal25-product-quality-blockers.md`, run focused Aukro tests, service build, IPS gates, and `git diff --check`.

## Execution Plan Requirement

Use `docs/21_execution_plans/EP-TASK-017-catalog-goal25-product-quality-blockers.md` before coding.
