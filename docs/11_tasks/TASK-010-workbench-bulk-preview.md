...
`docs/01_vision/VISION.md`, `docs/04_systems/SYS-001-aukro-service.md`, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/09_milestones/MS-003-ai-commerce-platform.md`, `docs/10_features/FEAT-006-ai-human-workbench.md`, `docs/10_features/FEAT-007-ecosystem-revenue-optimization.md`, `docs/10_features/FEAT-008-observability-reconciliation.md`, and `docs/11_tasks/TASK-009-operator-workbench-api.md`.

## Goal Impact

See `docs/22_goal_impact/GOAL-IMPACT-TASK-010.md`. This task advances Stage 6 bulk workflows by adding preview-only batching over existing safe workbench review items without introducing any live marketplace, downstream, approval, stock, price, or order mutation.
...
`AGENTS.md`, `AGENT_OPERATIONS.md`, protected intent docs, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, Stage 6 roadmap section, TASK-009 docs and validation report, workbench controller/service/types/tests, and local rawData metadata contracts.

## Validation Task

Create and complete `docs/12_validation/VAL-TASK-010-workbench-bulk-preview.md`, run the workbench test, service test suite, service build, strict audit, pre-coding gate, and deployment-readiness gate.
...
Use `docs/21_execution_plans/EP-TASK-010-workbench-bulk-preview.md` before coding.
