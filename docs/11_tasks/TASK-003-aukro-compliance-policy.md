...
`docs/01_vision/VISION.md`, `docs/04_systems/SYS-001-aukro-service.md`, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/09_milestones/MS-003-ai-commerce-platform.md`, and `docs/10_features/FEAT-004-aukro-compliance-policy.md`.

## Goal Impact

See `docs/22_goal_impact/GOAL-IMPACT-TASK-003.md`. This task protects account health and enables future automation by making marketplace publication decisions explicit, auditable, and fail-closed.
...
`AGENTS.md`, `docs/00_constitution/CONSTITUTION.md`, `docs/01_vision/VISION.md`, `docs/17_governance/PROJECT_INVARIANTS.md`, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/10_features/FEAT-004-aukro-compliance-policy.md`, `docs/14_prompts/PROMPT-TASK-003-aukro-compliance-policy.md`, `docs/16_operations/INTEGRATIONS.md`, and the existing offer service/controller files.

## Validation Task

Create `docs/12_validation/VAL-TASK-003-aukro-compliance-policy.md`, run the policy tests, TypeScript build, strict doc audit, pre-coding gate, and deployment-readiness gate.
...
Use `docs/21_execution_plans/EP-TASK-003-aukro-compliance-policy.md` before coding.
