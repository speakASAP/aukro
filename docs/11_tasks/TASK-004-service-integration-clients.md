...
`docs/01_vision/VISION.md`, `docs/04_systems/SYS-001-aukro-service.md`, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/10_features/FEAT-009-service-integration-clients.md`, and `docs/16_operations/INTEGRATIONS.md`.

## Goal Impact

See `docs/22_goal_impact/GOAL-IMPACT-TASK-004.md`. This task prepares safe future AI selling, approval, media, lead, marketing, payment, supplier, notification, and logging integrations.
...
`AGENTS.md`, protected intent docs, `docs/10_features/FEAT-009-service-integration-clients.md`, `docs/16_operations/INTEGRATIONS.md`, `shared/clients/*`, and `shared/resilience/*`.

## Validation Task

Create `docs/12_validation/VAL-TASK-004-service-integration-clients.md`, run shared tests/build, service build, strict audit, pre-coding gate, and deployment-readiness gate.
...
Use `docs/21_execution_plans/EP-TASK-004-service-integration-clients.md` before coding.
