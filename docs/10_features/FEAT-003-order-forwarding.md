...
related_adrs: []
---
# FEAT-003 Order Forwarding

## User or system need

Aukro orders must enter the internal order-processing flow reliably.

## Goal

Deliver order forwarding within the documented Aukro marketplace boundary.
...
Existing aukro-service capability area for order forwarding.
