...
goal_impact: docs/22_goal_impact/GOAL-IMPACT-TASK-017.md
---
...
`docs/00_constitution/CONSTITUTION.md`, `docs/01_vision/VISION.md`, `docs/10_features/FEAT-005-catalog-warehouse-publisher.md`, `docs/11_tasks/TASK-005-catalog-sell-action-draft-model.md`, `docs/11_tasks/TASK-012-catalog-content-preview-drafts.md`, and Catalog policy `catalog.product_quality.v1`.
...
- `docs/11_tasks/TASK-017-catalog-goal25-product-quality-blockers.md`
- `docs/21_execution_plans/EP-TASK-017-catalog-goal25-product-quality-blockers.md`
- `docs/22_goal_impact/GOAL-IMPACT-TASK-017.md`
- `docs/13_context_packages/CP-TASK-017-catalog-goal25-product-quality-blockers.md`
- `docs/14_prompts/PROMPT-TASK-017-catalog-goal25-product-quality-blockers.md`
- `docs/12_validation/VAL-TASK-017-catalog-goal25-product-quality-blockers.md`
