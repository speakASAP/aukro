...
`docs/01_vision/VISION.md`, `docs/00_constitution/CONSTITUTION.md`, `docs/02_business_case/BUSINESS_CASE.md`, `docs/10_features/FEAT-001-offer-management.md`.

## Goal Impact

Creates governance needed to keep future Aukro marketplace work traceable and validated. See `docs/22_goal_impact/GOAL-IMPACT-TASK-001.md`.

## Project invariants

Applies `docs/17_governance/PROJECT_INVARIANTS.md`.
