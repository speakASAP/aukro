...
goal_impact: docs/22_goal_impact/GOAL-IMPACT-TASK-011.md
---
...
- Official Aukro source URLs listed in `docs/16_operations/AUKRO_PLATFORM_RULES.md`

## Files to Create

- `docs/16_operations/AUKRO_PLATFORM_RULES.md`
- `docs/11_tasks/TASK-011-document-aukro-platform-rules.md`
- `docs/12_validation/VAL-TASK-011-document-aukro-platform-rules.md`
- `docs/13_context_packages/CP-TASK-011-document-aukro-platform-rules.md`
- `docs/14_prompts/PROMPT-TASK-011-document-aukro-platform-rules.md`
- `docs/21_execution_plans/EP-TASK-011-document-aukro-platform-rules.md`
- `docs/22_goal_impact/GOAL-IMPACT-TASK-011.md`
...
Create TASK-011 documentation package and update `TASKS.md`, `graph/project_graph.example.yaml`, and `docs/16_operations/AUKRO_PLATFORM_RULES.md`.
