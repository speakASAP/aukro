...
goal_impact: docs/22_goal_impact/GOAL-IMPACT-TASK-005.md
---
...
- `docs/13_context_packages/CP-TASK-005-catalog-sell-action-draft-model.md`
- `docs/14_prompts/PROMPT-TASK-005-catalog-sell-action-draft-model.md`
- `docs/21_execution_plans/EP-TASK-005-catalog-sell-action-draft-model.md`
- `docs/22_goal_impact/GOAL-IMPACT-TASK-005.md`
