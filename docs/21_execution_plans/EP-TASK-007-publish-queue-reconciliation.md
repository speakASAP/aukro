...
goal_impact: docs/22_goal_impact/GOAL-IMPACT-TASK-007.md
---
...
- `docs/12_validation/VAL-TASK-005-catalog-sell-action-draft-model.md`
- `docs/12_validation/VAL-TASK-006-ai-proposal-human-approval.md`
...
- `docs/12_validation/VAL-TASK-007-publish-queue-reconciliation.md`
- `docs/13_context_packages/CP-TASK-007-publish-queue-reconciliation.md`
- `docs/14_prompts/PROMPT-TASK-007-publish-queue-reconciliation.md`
- `docs/21_execution_plans/EP-TASK-007-publish-queue-reconciliation.md`
- `docs/22_goal_impact/GOAL-IMPACT-TASK-007.md`
