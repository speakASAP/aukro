...
Vision -> `docs/01_vision/VISION.md` -> System -> `docs/04_systems/SYS-001-aukro-service.md` -> Feature -> `docs/10_features/FEAT-008-observability-reconciliation.md` -> Task -> `docs/11_tasks/TASK-007-publish-queue-reconciliation.md` -> Execution Plan -> `docs/21_execution_plans/EP-TASK-007-publish-queue-reconciliation.md` -> Coding Prompt -> `docs/14_prompts/PROMPT-TASK-007-publish-queue-reconciliation.md` -> Code -> Validation -> `docs/12_validation/VAL-TASK-007-publish-queue-reconciliation.md`.
