...
Vision -> `docs/01_vision/VISION.md` -> Feature -> `docs/10_features/FEAT-005-catalog-warehouse-publisher.md` -> Task -> `docs/11_tasks/TASK-017-catalog-goal25-product-quality-blockers.md` -> Execution Plan -> `docs/21_execution_plans/EP-TASK-017-catalog-goal25-product-quality-blockers.md` -> Coding Prompt -> `docs/14_prompts/PROMPT-TASK-017-catalog-goal25-product-quality-blockers.md` -> Code -> Validation -> `docs/12_validation/VAL-TASK-017-catalog-goal25-product-quality-blockers.md`.
