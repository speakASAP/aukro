...
Vision -> `docs/01_vision/VISION.md` -> System -> `docs/04_systems/SYS-001-aukro-service.md` -> Feature -> `docs/10_features/FEAT-007-ecosystem-revenue-optimization.md` -> Task -> `docs/11_tasks/TASK-008-revenue-analytics-events.md` -> Execution Plan -> `docs/21_execution_plans/EP-TASK-008-revenue-analytics-events.md` -> Coding Prompt -> `docs/14_prompts/PROMPT-TASK-008-revenue-analytics-events.md` -> Code -> Validation -> `docs/12_validation/VAL-TASK-008-revenue-analytics-events.md`.
