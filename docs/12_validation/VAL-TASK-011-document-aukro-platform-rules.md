...
id: VAL-TASK-011
status: reviewed
target: docs/11_tasks/TASK-011-document-aukro-platform-rules.md
owner: Engineering
created: 2026-06-29
last_updated: 2026-06-29
completeness_level: complete
upstream:
  - docs/11_tasks/TASK-011-document-aukro-platform-rules.md
downstream: []
related_adrs: []
---
...
|---|---|---|
| Official Aukro source URLs and review date recorded | Pass | `docs/16_operations/AUKRO_PLATFORM_RULES.md` |
| Automation hard stops documented | Pass | `docs/16_operations/AUKRO_PLATFORM_RULES.md` |
| WebAPI uncertainty marked instead of guessed | Pass | `docs/16_operations/AUKRO_PLATFORM_RULES.md` |
| Listing-content, prohibited-goods, privacy, cookie, and robots boundaries captured | Pass | `docs/16_operations/AUKRO_PLATFORM_RULES.md` |
...
The current public official Aukro WebAPI endpoint, authentication-flow, and per-endpoint rate-limit documentation was not found during source review. The concrete missing-evidence marker is recorded in `docs/16_operations/AUKRO_PLATFORM_RULES.md`, so live publish automation remains blocked until explicit integration evidence exists. An initial strict doc audit also required template alignment; the TASK-011 documents were updated to match repository templates.

## Recommendation

Accept with follow-up: before any live Aukro mutation, obtain or verify official WebAPI/key/rate-limit documentation or explicit Aukro-approved integration evidence and update `docs/16_operations/AUKRO_PLATFORM_RULES.md` plus policy gates if the rules change.
