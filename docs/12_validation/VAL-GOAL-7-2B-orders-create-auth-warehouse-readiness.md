...
| Chain node | Evidence |
|---|---|
| Vision | `docs/01_vision/VISION.md` says Aukro forwards received orders to the order domain and must not own order lifecycle truth. |
...
- IPS strict doc audit initially failed on this report shape; the report was revised to match `docs/18_templates/VALIDATION_REPORT_TEMPLATE.md`.
