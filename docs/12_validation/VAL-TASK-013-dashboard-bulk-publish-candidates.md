...
TASK-013 supports `docs/10_features/FEAT-005-catalog-warehouse-publisher.md` by making catalog-driven Aukro selling manageable in batches while preserving draft-first safety, policy gates, and record-only publish intent.
