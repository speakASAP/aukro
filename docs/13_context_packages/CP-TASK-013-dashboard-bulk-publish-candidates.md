...
`TASK-013` in `docs/11_tasks/TASK-013-dashboard-bulk-publish-candidates.md`.

## Upstream traceability

`docs/00_constitution/CONSTITUTION.md`, `docs/01_vision/VISION.md`, `docs/04_systems/SYS-001-aukro-service.md`, `docs/10_features/FEAT-005-catalog-warehouse-publisher.md`, `docs/11_tasks/TASK-005-catalog-sell-action-draft-model.md`, `docs/11_tasks/TASK-007-publish-queue-reconciliation.md`, `docs/11_tasks/TASK-012-catalog-content-preview-drafts.md`, `docs/16_operations/AUKRO_PLATFORM_RULES.md`, and `docs/22_goal_impact/GOAL-IMPACT-TASK-013.md`.
