...
downstream:
  - docs/14_prompts/PROMPT-TASK-005-catalog-sell-action-draft-model.md
related_adrs: []
---
...
`TASK-005` in `docs/11_tasks/TASK-005-catalog-sell-action-draft-model.md`.

## Upstream traceability

`docs/00_constitution/CONSTITUTION.md`, `docs/01_vision/VISION.md`, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/10_features/FEAT-005-catalog-warehouse-publisher.md`, and `docs/21_execution_plans/EP-TASK-005-catalog-sell-action-draft-model.md`.
