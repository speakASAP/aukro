...
`TASK-007` in `docs/11_tasks/TASK-007-publish-queue-reconciliation.md`.

## Upstream traceability

`docs/00_constitution/CONSTITUTION.md`, `docs/01_vision/VISION.md`, `docs/08_roadmap/AI_COMMERCE_ROADMAP.md`, `docs/10_features/FEAT-008-observability-reconciliation.md`, `docs/21_execution_plans/EP-TASK-007-publish-queue-reconciliation.md`, TASK-005 draft model docs, and TASK-006 human approval docs.
